      ...
      <div className="flex gap-2 bg-white/5 p-1.5 rounded-2xl border border-white/5 w-fit">
        <button
          ...
          className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all ${
            activeTab === 'manage' ? 'bg-sky-500 text-white' : 'text-gray-400 hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black transition-all ${
            activeTab === 'registrations' ? 'bg-[#D4AF37] text-black' : 'text-gray-400 hover:text-white'
          }`}
        >
          ...
          <div className="bg-white/5 rounded-[2rem] border border-white/10 p-6 shadow-2xl relative overflow-hidden">
            ...
            <form onSubmit={handleSaveCamp} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label className="text-xs text-gray-400 block mb-1">رابط صورة المعسكر</label>
                  <input type="url" name="image" value={campForm.image} onChange={handleCampInputChange} className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-sky-500 text-white" placeholder="https://..." required />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label className="text-xs text-gray-400 block mb-1">نقاط التركيز (افصل بفصلة ,)</label>
                  <input type="text" name="focus" value={campForm.focus} onChange={handleCampInputChange} className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-sky-500 text-white" placeholder="التصدي, القيادة, السرعة" />
                </div>
              </div>
              ...
              <div className="p-4 bg-white/[0.02] border border-white/5 rounded-2xl grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="url" name="coachImage" value={campForm.coachImage} onChange={handleCampInputChange} className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm outline-none focus:border-sky-500 text-white" placeholder="https://..." />
                </div>
              </div>
