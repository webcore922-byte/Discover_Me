...
export const Error = ({ message, onRetry }) => (
  <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 bg-[var(--color-bg-main)]">
    ...
    <div className="w-full max-w-md p-8 bg-[var(--color-bg-card)] border border-[var(--color-gold-main)] rounded-2xl shadow-[0_0_30px_rgba(212,175,55,0.2)] flex flex-col items-center text-center">
      ...
      <Typography variant="h3" className="text-white mb-3 font-serif tracking-wide">
        حدث خطأ تقني
      </Typography>
      ...
      <Button 
        ...
        className="bg-[var(--color-gold-main)] hover:bg-yellow-600 text-black px-10 py-3 rounded-lg font-bold transition-all duration-300 transform hover:scale-105 shadow-lg"
      >
        إعادة المحاولة
      </Button>
    </div>
