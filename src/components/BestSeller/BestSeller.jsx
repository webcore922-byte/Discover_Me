...
const BestSeller = () => {
  const { search, addedProductId, products, addToCart, load, error, getproduct } = useStore();
  ...
  const displayed = bestSellers.slice(
              ...
              <div
                ...
                <div className="flex gap-2 mt-auto">
                  <Link
                    ...
                    className="flex items-center justify-center gap-1.5 w-1/3 py-3 border-2 border-[var(--color-gold-main)]/50 text-[var(--color-gold-main)] rounded-lg font-bold transition-all duration-300 hover:border-[var(--color-gold-main)] hover:bg-[var(--color-gold-main)]/10 text-sm">
                    <FaInfoCircle />
                    <span>تفاصيل</span>
                  </Link>
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 border-2 transition-all duration-500 rounded-lg font-bold text-sm
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((n) => (
                <button
                  ...
                  className={`w-9 h-9 text-sm font-black rounded-xl transition-all
                    ${n === safePage
                      ? "bg-[var(--color-gold-main)] text-black"
