...
const CategoryCard = ({
  ...
  image
    ...
    <div className="absolute bottom-4 left-0 w-full px-4">
      <span className="text-[var(--color-text-white)] font-bold text-lg block">{title}</span>
...
const CategoriesSection = () => {
  ...
  return <div>
      <section className="px-12 py-6 relative">
        <h2 className="text-2xl font-bold mb-6 dark:text-[var(--color-text-white)] text-[var(--color-gold-main)]">الأقسام</h2>
        ...
        <Swiper modules={[Autoplay, Navigation]} navigation={{
        nextEl: ".swiper-button-next",
        prevEl: ".swiper-button-prev"
      }} spaceBetween={15} loop={true} autoplay={{
        delay: 2000,
