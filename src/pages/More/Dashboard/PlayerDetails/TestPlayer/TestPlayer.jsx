...
return (
    <div className="min-h-screen bg-[var(--color-bg-main)] text-[var(--color-text-white,white)] p-4 md:p-10 font-sans" dir="rtl">
            ...
            <div className="bg-[var(--color-bg-card)] rounded-[2.5rem] p-8 border border-[var(--color-border)]/20 h-full flex flex-col justify-between">
              <div>
                ...
                <button 
                    ...
                    className="w-full py-5 bg-[var(--color-bg-card)] border border-[var(--color-border)]/30 rounded-2xl text-[var(--color-gold-main)] font-black hover:bg-[var(--color-gold-main)] hover:text-black transition-all flex items-center justify-center gap-3 group"
                >
              ...
              <div className="mt-6 pt-6 border-t border-[var(--color-border)]/30 space-y-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    style={{ colorScheme: 'var(--color-text-gray)' }}
                ...
                <div>
                  ...
                  <input 
                    ...
                    style={{ colorScheme: 'var(--color-bg-main)' }}
                ...
                <div>
                  ...
                  <input type="text" value={fieldTest.location} placeholder="مثال: نادي الجزيرة، القاهرة" onChange={e => setFieldTest({...fieldTest, location: e.target.value})} className="w-full bg-[var(--color-bg-card)] border border-[var(--color-border)]/30 rounded-xl px-3 py-2 text-sm text-[var(--color-text-main,white)] outline-none focus:border-[var(--color-gold-main)]" />
                </div>
                <div>
                  <label className="text-[11px] text-[var(--color-text-gray)] block mb-1">اسم الكشاف المسؤول</label>
                  <input type="text" value={fieldTest.coachName} placeholder="مثال: كابتن محمد سمير" onChange={e => setFieldTest({...fieldTest, coachName: e.target.value})} className="w-full bg-[var(--color-bg-card)] border border-[var(--color-border)]/30 rounded-xl px-3 py-2 text-sm text-[var(--color-text-main,white)] outline-none focus:border-[var(--color-gold-main)]" />
                </div>
              </div>
              ...
              <div className="space-y-4 mt-10">
                <button 
                  ...
                  className="w-full bg-[var(--color-gold-main)] text-black font-black py-5 rounded-2xl hover:scale-[1.02] active:scale-95 transition-all text-lg uppercase italic shadow-md shadow-amber-500/20"
                >
