...
const NewsDetails = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen dark:bg-[#0e1011] bg:[var(--color-bg-main)] flex items-center justify-center text-[#D4AF37] font-bold relative">
  ...
  if (!news) {
    return (
      <div className="min-h-screen dark:bg-[#0e1011] bg:[var(--color-bg-main)] flex flex-col items-center justify-center dark:text-white text-[var(--color-text-gray)] gap-4 p-4 text-center">
  ...
  return (
    <div 
      className="min-h-screen dark:bg-[#0e1011] bg:[var(--color-bg-main)] dark:text-white text-[var(--color-text-gray)]  py-12 px-4 sm:px-6 md:px-8 lg:px-12 font-sans relative overflow-hidden bg-cover bg-center bg-no-repeat bg-fixed w-full bit-overflow-x-hidden"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-10 w-full overflow-hidden">
        ...
        <button 
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-xs dark:text-gray-300 hover:text-[#D4AF37] transition-all bg-white/5 hover:bg-white/10 px-4 py-2.5 rounded-xl border border-white/5 cursor-pointer w-fit group"
        >
            ...
            <div className="space-y-12 pt-4 w-full">
              {news.sections && news.sections.map((section, index) => (
                <div key={index} className="border-r-2 border-[#D4AF37]/40 pr-4 md:pr-6 space-y-4 group w-full min-w-0">
                  ...
                  {/* عنوان السكشن الفني */}
                  <h3 className="text-lg md:text-xl font-bold text-[#D4AF37] flex items-center gap-2 transition-colors dark:group-hover:text-white break-words">
