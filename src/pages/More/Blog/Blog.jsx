...
const BlogContent = () => {
  ...
  return <div className="bg-[var(--color-bg-main)] min-h-screen p-8 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {articles.map(article => <div key={article.id} className="bg-[var(--color-bg-card)] border border-[var(--color-border)] rounded-xl overflow-hidden p-4 group">
            ...
            <div className="p-5">
              ...
              <button className="text-[var(--color-text-white)] bg-[var(--color-gold-main)] px-4 py-1 rounded-full text-sm" onClick={() => {
...
const Blog = () => {
  return <Suspense fallback={<div className="min-h-screen bg-[var(--color-bg-main)] flex items-center justify-center text-[var(--color-gold-main)]">
          جاري التحميل...
        </div>}>
      <BlogContent />
    </Suspense>;
