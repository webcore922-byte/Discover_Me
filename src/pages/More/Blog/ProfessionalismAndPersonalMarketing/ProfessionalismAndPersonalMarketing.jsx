    ...
    <div className="min-h-screen bg-[var(--color-bg-main)] text-[var(--color-text-white)] font-sans" dir="rtl">
      ...
      <main className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-32">
          ...
          <div className="bg-[var(--color-bg-card)] p-10 rounded-3xl border border-[var(--color-gold-main)]">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center bg-[var(--color-bg-card)] rounded-[3rem] p-8 lg:p-16 border border-[var(--color-gold-main)]">
          
          <div>
            <h2 className="text-4xl font-bold mb-6 dark:text-[var(--color-text-white)] text-[var(--color-text-main)]">
              جاهز لجذب <span className="text-[var(--color-gold-main)]">الوكلاء؟</span>
            </h2>
