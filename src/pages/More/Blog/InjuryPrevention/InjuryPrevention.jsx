...
const InjuryPrevention = () => {
  return (
    <div className="min-h-screen bg-[var(--color-bg-main)] text-[var(--color-text-white)] font-sans selection:bg-[var(--color-gold-main)] selection:text-black" dir="rtl">
      
      
      <div className="h-10 border-b border-[var(--color-border)]/20 shadow-sm"></div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 lg:py-20">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center mb-32">
          <div className="lg:col-span-7 order-2 lg:order-1">
            ...
            <p className="text-xl text-[var(--color-text-gray)] leading-relaxed max-w-xl mb-10 border-l-4 border-[var(--color-gold-main)] pl-6">
          ...
          <div className="lg:col-span-5 order-1 lg:order-2 relative">
            ...
            <div className="relative z-10 rounded-[40px] overflow-hidden border-2 border-[var(--color-border)] rotate-3 hover:rotate-0 transition-transform duration-500">
              <img 
                src="/InjuryPrevention.jpeg" 
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-32">
          ...
          <div className="group relative bg-[var(--color-bg-card)] p-12 rounded-[2rem] border-t-4 border-[var(--color-gold-main)] shadow-2xl">
            <div className="absolute top-8 left-8 text-6xl font-black text-white/5 group-hover:text-[var(--color-gold-main)]/10 transition-colors">01</div>
          ...
          <div className="group relative bg-[var(--color-bg-card)] p-12 rounded-[2rem] border-b-4 border-[var(--color-gold-main)] shadow-2xl md:mt-12">
            <div className="absolute top-8 left-8 text-6xl font-black text-white/5 group-hover:text-[var(--color-gold-main)]/10 transition-colors">02</div>
        ...
        <div className="relative bg-[var(--color-gold-main)] text-black p-12 lg:p-20 rounded-br-[100px] overflow-hidden mb-32">
