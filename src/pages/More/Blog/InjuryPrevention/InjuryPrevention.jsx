      ...
      <main className="max-w-6xl mx-auto px-6 py-12 lg:py-20">
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-32">
          ...
          <div className="group relative bg-[var(--color-bg-card)] p-12 rounded-[2rem] border-t-4 border-[var(--color-gold-main)] shadow-2xl text-right">
            <div className="absolute top-8 right-8 text-6xl font-black opacity-10 group-hover:text-[var(--color-gold-main)]/10 transition-colors">
              01
            </div>
            <h3 className="text-2xl font-bold text-[var(--color-gold-main)] mb-6">
              الإحماء الديناميكي
            </h3>
        ...
        <div className="grid lg:grid-cols-3 gap-12 border-t border-[var(--color-border)]/30 pt-16">
          ...
          <div>
            <h4 className="text-[var(--color-gold-main)] font-black text-lg mb-4 uppercase">
              التغذية الوقائية
            </h4>
