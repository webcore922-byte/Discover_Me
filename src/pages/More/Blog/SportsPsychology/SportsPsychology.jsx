    ...
    <div className="bg-[var(--color-bg-main)] min-h-screen p-6 lg:p-12 text-[var(--color-text-gray)] font-sans">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16 border-r-8 border-[var(--color-border)] pr-6 py-2">
          <Typography variant="h1" className="text-5xl lg:text-7xl font-black uppercase tracking-tight text-[var(--color-text-white)] mb-4">
            العقل <span className="text-gradient-gold font-black">أولاً</span>
          </Typography>
          <Typography className="text-xl text-[var(--color-text-gray)] max-w-3xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <article className="prose prose-invert max-w-none">
              <Typography variant="h2" className="mb-8 font-bold text-3xl text-[var(--color-text-white)]">
                سيكولوجية المستطيل الأخضر
              </Typography>
              
              <p className="text-[var(--color-text-gray)] text-lg leading-loose mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
                <div className="glass-card hover-gold-card p-6 rounded-2xl card-shine group">
                  <Typography variant="h5" className="mb-3 text-[var(--color-text-white)] group-hover:text-[var(--color-gold-main)] transition-colors">
                    المرونة الإدراكية
                  </Typography>
                  <Typography className="text-sm text-[var(--color-text-gray)]">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <Card className="bg-[var(--color-bg-card)] border border-[var(--color-border)] shadow-none rounded-2xl overflow-hidden">
              <CardBody className="p-0">
                <div className="bg-[var(--color-border)] p-4 text-center">
                ...
                <List className="p-2 text-[var(--color-text-gray)]">
                  <ListItem className="hover:bg-[var(--color-bg-main)] focus:bg-[var(--color-bg-main)]">
                    <ListItemPrefix>
            ...
            <div className="p-6 border border-dashed border-[var(--color-border)] rounded-2xl opacity-60">
              <Typography className="text-xs uppercase tracking-widest text-[var(--color-gold-main)] mb-2 font-bold">الحالة الفنية</Typography>
              <Typography className="text-sm italic text-[var(--color-text-gray)]">
