...
const PrivacyPolicy = () => {
  ...
  return <div className="min-h-screen bg-[var(--color-bg-main)] text-[var(--color-text-white)] py-20 px-4 md:px-10" dir="rtl">
      <div className="max-w-4xl mx-auto">
        
        <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-white/60 hover:text-[var(--color-gold-main)] transition-all mb-10 group">
        ...
        <div className="grid gap-8">
          {sections.map((section, index) => <div key={index} className="glass-card p-8 rounded-[2rem] border border-white/5 hover:border-[var(--color-gold-main)]/30 transition-all duration-500 group">
              <div className="flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="space-y-3">
                  <h3 className="text-2xl font-black text-[var(--color-text-white)] group-hover:text-[var(--color-gold-main)] transition-colors italic">
                    {section.title}
                  </h3>
        ...
        <div className="mt-16 glass-card p-10 rounded-[3rem] border border-[var(--color-gold-main)]/20 text-center relative overflow-hidden">
          ...
          <Link to="/contact-us" className="inline-block bg-[var(--gold-gradient)] text-black font-black px-10 py-4 rounded-full shadow-[var(--gold-glow)] hover:scale-105 transition-transform uppercase italic">
