...
const SuccessStoriesRonaldo = () => {
            ...
            <div className="w-full grid grid-cols-2 border border-[var(--color-border)] rounded-xl overflow-hidden bg-[var(--color-bg-card)] mb-10 flex-shrink-0">
              <div className="flex flex-col items-center justify-center p-4 sm:p-2 border-b border-l border-[var(--color-border)]">
                <div className="flex items-center gap-1 mb-1">
                  ...
                  <Typography className="text-gradient-gold font-bold text-base">دوري الأبطال</Typography>
                </div>
                <Typography className="text-[var(--color-text-white)] font-bold text-xs md:text-sm">5</Typography>
              </div>
              <div className="flex flex-col items-center justify-center border-b border-[var(--color-border)]">
                ...
                <Typography className="text-[var(--color-text-white)] font-bold text-xs md:text-sm">850+</Typography>
              </div>
              ...
              <div className="flex flex-col items-center justify-center">
                <div className="flex items-center gap-1 mb-1">
                  ...
                  <Typography className="text-gradient-gold font-bold text-sm">أهداف دولية</Typography>
                </div>
                <Typography className="text-[var(--color-text-white)] font-bold text-xs md:text-sm">125+</Typography>
              </div>
            </div>
  ...
  <Card className="border border-[var(--color-border)] bg-[var(--color-bg-card)] rounded-xl p-4 shadow-none flex flex-col h-full min-w-0 ">
    ...
    <Typography className="text-[var(--color-text-gray)] text-xs md:text-base leading-relaxed text-right">
       بدأ كريستيانو من ظروف قاسية في جزيرة ماديرا، وبفضل انضباطه الحديدي انتقل إلى مانشستر يونايتد ليصبح تحت قيادة فيرجسون أفضل لاعب في العالم. هناك صقل مهاراته وحقق أول كرة ذهبية وأول دوري أبطال في مسيرته.
    </Typography>
  </Card>
  ...
  <div className="rounded-xl border border-[var(--color-border)] overflow-hidden flex min-w-0">
    ...
    <div className="grid grid-cols-1 md:grid-cols-[1fr_1.6fr] gap-4 items-stretch">
      ...
      <Card className="border border-[var(--color-border)] bg-[var(--color-bg-card)] rounded-xl p-4 shadow-none flex flex-col h-fit min-w-0 order-1 md:order-2">
        ...
        <Typography className="text-[var(--color-text-gray)] text-xs md:text-base leading-relaxed text-right">
         في ريال مدريد، تحول رونالدو إلى هداف تاريخي للنادي بمتوسط أكثر من هدف في كل مباراة. قاد "الميرينغي" لتحقيق 4 ألقاب دوري أبطال، منها ثلاثة متتالية، محطماً كافة الأرقام القياسية في تاريخ المسابقة. </Typography>
      </Card>
    </div>
  </div>
</Card>
              ...
              <div className="flex flex-col items-end w-full">
                ...
                <Card className="w-full border border-[var(--color-border)] bg-[var(--color-bg-card)] rounded-xl p-5 md:p-6 shadow-inner ">
                  <Typography className="text-[var(--color-text-gray)] sm:text-xs md:text-sm leading-relaxed text-right ">
                    يُعد رونالدو التجسيد الحي لمعنى "العمل الشاق يتفوق على الموهبة". من خلال نظام غذائي صارم وتدريبات مكثفة، حافظ على قمته الفنية حتى سن الأربعين. رحلته هي رسالة لكل شاب بأن سقف الطموح لا يحده إلا مدى استعدادك للتضحية من أجل هدفك.
                  </Typography>
                </Card>
              </div>
            </div>
...
export default SuccessStoriesRonaldo;