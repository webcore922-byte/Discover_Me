      ...
      <div className="min-h-screen bg-[var(--color-bg-main)] text-[var(--color-text-white)] pb-10">
        <section className="px-4 md:px-8 py-6">
          <div className="w-full max-h-[430px] aspect-[16/9] md:aspect-[21/9] rounded-2xl flex items-center p-6 md:p-12 relative overflow-hidden gold-glow-border bg-[url('/storebg.png')] bg-cover bg-center bg-no-repeat">
            ...
            <div className="relative z-10 text-[var(--color-text-white)] max-w-lg">
              ...
              <Link to="/products" className="inline-block">
                <button onClick={() => setSelectcategory(null)} className="px-2 py-1.5 md:px-10 md:py-4 rounded-xl font-bold text-black bg-gradient-to-r from-[var(--color-btn-start)] to-[var(--color-btn-end)] hover:scale-105 transition-transform duration-300 text-sm md:text-lg shadow-lg">
                  تسوق الآن
                </button>
              </Link>
            </div>
        ...
        <section className="px-8 py-12">
          <h2 className="text-3xl font-bold dark:text-[var(--color-text-white)] text-[var(--color-gold-main)] mb-8 border-r-4 border-[var(--color-gold-main)] pr-4">
            الأكثر مبيعاً
          </h2>
          <BestSeller />
        </section>
