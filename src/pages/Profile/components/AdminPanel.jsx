...
const EditableStatCard = ({
  ...
  readOnly
    ...
    <input type="text" value={value} readOnly={readOnly} className="bg-transparent border-b-2 border-dashed border-white/5 opacity-70 cursor-not-allowed w-full text-2xl font-black text-[var(--color-text-white)] italic outline-none pb-2 px-2" />
  </div>;
const AdminPanel = ({
  adminType,
  editData
