...
const ContactUs = () => {
  ...
  return (
    <div
      className="min-h-screen bg-[var(--color-bg-main)] text-[var(--color-text-white)] p-6 md:p-12 font-sans"
      dir="rtl"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4">
            <div className="glass-card hover-gold-card p-8 rounded-[2rem] h-full card-shine relative overflow-hidden">
              <h3 className="text-2xl font-black mb-10 border-r-4 border-[var(--color-gold-main)] pr-4 italic">
                معلوماتنا
              </h3>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black text-[var(--color-text-gray)] uppercase tracking-widest">
                      البريد الإلكتروني
                    </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs font-black text-[var(--color-text-gray)] uppercase mr-2 italic">
                      الاسم الكامل
                    </label>
                    <input
                      type="text"
