...
const NotFound = () => {
  return <div className="min-h-screen bg-[var(--color-bg-main)] flex items-center justify-center px-6 py-12 overflow-hidden relative" dir="rtl">
      ...
      <div className="max-w-4xl w-full text-center relative z-10">
        ...
        <div className="relative inline-block mb-4 md:mb-0">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="glass-card px-5 py-3 md:px-10 md:py-6 rounded-2xl md:rounded-full border-white/10 shadow-2xl rotate-[-2deg] md:rotate-[-3deg] gold-glow-border mx-4">
              <p className="text-lg sm:text-xl md:text-3xl font-black text-[var(--color-text-white)] italic uppercase tracking-widest flex items-center justify-center gap-2 md:gap-4 whitespace-nowrap">
        ...
        <div className="mt-2 md:mt-6 space-y-4 md:space-y-8">
          <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black text-[var(--color-text-white)] italic uppercase tracking-tight leading-tight">
             أضعت الطريق للملعب؟
          </h2>
        ...
        <div className="mt-10 md:mt-16 flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-8">
          <Link to="/" className="w-full sm:w-auto">
            <Button size="lg" className="w-full sm:w-auto flex items-center justify-center gap-3 bg-[var(--gold-gradient)] text-black font-black text-lg md:text-xl py-5 md:py-6 px-8 md:px-14 rounded-2xl shadow-[var(--gold-glow)] hover:scale-[1.03] active:scale-95 transition-all italic border-b-4 md:border-b-8 border-black/20">
          ...
          <Link to="/contact-us" className="w-full sm:w-auto">
            <Button size="lg" variant="outlined" className="w-full sm:w-auto flex items-center justify-center gap-3 border-[var(--color-border)] text-[var(--color-gold-main)] font-black text-lg md:text-xl py-5 md:py-6 px-8 md:px-14 rounded-2xl hover:bg-white/5 transition-all italic shadow-inner">
